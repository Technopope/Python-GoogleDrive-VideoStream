...
#            url = url + "?includeDeleted=false&includeSubscribed=false&maxResults=1000"
        ...
        if folderID == 'root' or not isTeamDrive:
            url = url + "?includeTeamDriveItems=true&supportsTeamDrives=true&includeDeleted=true&includeSubscribed=true&maxResults=300"
        else:
...
#                            foldericon = re.sub('\&gd\=true', '', foldericon)
    ...
    ##
    def getPlaybackCall(self, package=None, title='', isExact=True, contentType=None, override=False, MD5List=None, fileIDList=None):
